...
function AddBudget(props) {
    ...
    function handleChange(event){
        ...
        setBudget((prev) => (
            {...prev, [name]: type === 'radio' ? Number(value) : value}
        ))
    }
    ...
    return (
        <div className=" h-auto">
            <div className=" flex justify-center items-center overflow-y-auto overflow-x-hidden fixed inset-0 z-50 outline-none focus:outline-none">
                <div className="relative w-auto">
                    {/*content*/}
                    <div className="border-0 rounded shadow-lg relative flex flex-col space-y-6 w-full p-4 bg-white outline-none focus:outline-none">
                        {/*header*/}
                            ...
                            <form className=" from-orange-400 grid grid-cols-2 gap-x-3 grid-flow-row">
                                ...
                                <div className=" col-start-1">
                                    ...
                                    <input  type="text" name="name" value={budget.name} onChange={handleChange}
                                            className=" form-input w-full mb-3 px-1 focus:ring-0 py-1 rounded-md border-gray-200 focus:border-gray-400 hover:border-gray-300"
                                    />
                                </div>
                                <div className=" col-start-1">
                                    <h4 className=" text-sm font-light text-gray-500">Amount</h4>
                                    <input  className=" form-input w-full px-1 focus:ring-0 py-1 rounded-md border-gray-200 focus:border-gray-400 hover:border-gray-300"
                                            type="number" name="amount" value={budget.amount} onChange={handleChange}
                                    /> 
                                </div>
                                <div>
                                    <h4 className=" text-sm font-light text-gray-500">Currency</h4>
                                    <select className=" form-select w-full px-2 focus:ring-0 py-1 rounded-md border-gray-200 focus:border-gray-400 hover:border-gray-300"
                                            placeholder="Type Bottom Text" name="currency" value={budget.currency} onChange={handleChange}
                                    >
                                ...
                                <div className=" col-start-1 col-span-1">
                                    ...
                                    <select name="budgetedFor" value={budget.budgetedFor} onChange={handleChange}
                                ...
                                <div className=" col-start-1 col-span-1">
                                    ...
                                    <input  type="date" className=" form-input w-full px-2 focus:ring-0 py-2 rounded-md border-gray-200 focus:border-gray-400 hover:border-gray-300"
                                            value={budget.startDate} name="startDate" onChange={handleChange}
                                    />
                                </div>                                
                            </form>
                        </div>
